...
while True:
    ...
    while not profil_id.isnumeric() and profil_id != "STOP":
        print("Veuillez entrer l'Id du profil pour lequel vous désirez des recommandations. Entrer 'STOP' pour arrèter le programme.")
    ...
    print(recommandation_array)

    # Affichage des recommandations

    print("\nLes films que nous vous recommandons sont:\n")

    for movie in recommandation_array[0:5]:
        print("- " + movie[1])
