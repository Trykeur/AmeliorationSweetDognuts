...
class Profil:
    ...
    def __init__(self, id):
        ...
        # Remplissage du tableau des artistes en calculant leur score de désirabilité
    ...
    def get_watched_artist(self):
        # Renvoie un tableau contenant les artistes regardés par l'utilisateur
    ...
    def get_watched_movie(self):
        # Renvoie un tableau contenant les films regardés par l'utilisateur tout en calculant 
        # l'indice de dérirabilité dudit film en fonction de la note que l'utilisateur lui a apposé
    ...
    def get_artists_to_request(self):
        # Renvoie une chaine d'Id d'artistes destinée à une requète SQL
    ...
    def get_movie_to_request(self):
        # Renvoie une chaine d'Id de films destinée à une requète SQL
